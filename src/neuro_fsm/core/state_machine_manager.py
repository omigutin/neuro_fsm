...
from ..models import StatesTuple
...
class StateMachineManager:
    ...
    def __init__(self, raw_config: Optional[Any] = None) -> None:
        ...
        """
        self._config: Optional[StateMachineConfig] = self._parse_raw_config(raw_config) if raw_config else None
    ...
    def create_state_machine(self, raw_config: Optional[Any] = None) -> StateMachine:
        """
            Создаёт новую машину состояний и возвращает её.
            Args:
                raw_config: Необязательная индивидуальная конфигурация.
            Returns:
                StateMachine: новая машина состояний.
        """
        self.set_config(raw_config)
        machine = StateMachine(self._config)
